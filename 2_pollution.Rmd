...
madrid_pollution <- madrid %>% 
  ...
  summarise(EBE=max(EBE, na.rm=TRUE))
...
```{r subtract-dfs}
# Your code below:
max(pollution_2001 -pollution_2006)
...
diff <- pollution_2006 - pollution_2001
mi_poll <- min(pollution_2006 - pollution_2001)
```
...
# Your code below:
pollution_diff <- diff %>% 
  pivot_longer(cols = everything(), names_to = 'pollutants', values_to = 'difference')
```
...
# Your code below:
max_pollution_dif <- pollution_diff %>% 
